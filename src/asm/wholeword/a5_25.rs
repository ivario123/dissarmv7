...
mod test {
    ...
    fn test_parse_sadd16() {
        ...
        let target: Thumb = thumb::Sadd16::builder()
    ...
    fn test_parse_sasx() {
        ...
        let target: Thumb = thumb::Sasx::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_ssax() {
        ...
        let target: Thumb = thumb::Ssax::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_ssub16() {
        ...
        let target: Thumb = thumb::Ssub16::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_sadd8() {
        ...
        let target: Thumb = thumb::Sadd8::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_ssub8() {
        ...
        let target: Thumb = thumb::Ssub8::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_qadd16() {
        ...
        let target: Thumb = thumb::Qadd16::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_qasx() {
        ...
        let target: Thumb = thumb::Qasx::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_qsax() {
        ...
        let target: Thumb = thumb::Qsax::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_qsub16() {
        ...
        let target: Thumb = thumb::Qsub16::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_qadd8() {
        ...
        let target: Thumb = thumb::Qadd8::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_qsub8() {
        ...
        let target: Thumb = thumb::Qsub8::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_shadd16() {
        ...
        let target: Thumb = thumb::Shadd16::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_shasx() {
        ...
        let target: Thumb = thumb::Shasx::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_shsax() {
        ...
        let target: Thumb = thumb::Shsax::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_shsub16() {
        ...
        let target: Thumb = thumb::Shsub16::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_shadd8() {
        ...
        let target: Thumb = thumb::Shadd8::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_shsub8() {
        ...
        let target: Thumb = thumb::Shsub8::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
