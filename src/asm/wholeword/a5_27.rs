...
mod test {
    ...
    fn test_parse_qadd() {
        ...
        let target: Thumb = thumb::Qadd::builder()
    ...
    fn test_parse_qdadd() {
        ...
        let target: Thumb = thumb::Qdadd::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_qsub() {
        ...
        let target: Thumb = thumb::Qsub::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_qdsub() {
        ...
        let target: Thumb = thumb::Qdsub::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_sel() {
        ...
        let target: Thumb = thumb::Sel::builder()
            .set_rd(Some(Register::R2))
            .set_rm(Register::R3)
            .set_rn(Register::R3)
            .complete()
    ...
    fn test_parse_clz() {
        ...
        let target: Thumb = thumb::Clz::builder()
            .set_rd(Register::R2)
            .set_rm(Register::R3)
            .complete()
            .into();
