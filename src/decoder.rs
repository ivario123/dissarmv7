        ...
        'outer_block: {
            match self.1 {
                ...
                Thumb::AddSPImmediate(add) => {
                    ...
                    pseudo!([
                        ...
                        if (s) {
                            SetNFlag(result);
                            SetZFlag(result);
                            SetCFlag(Register("SP&"),imm,false,false);
                            SetVFlag(Register("SP&"),imm,false,false);
                        }
                        rd = result;
                    ])
                ...
                Thumb::B(b) => {
                    ...
                    pseudo!([
                        // let target = Register("PC") & (!(0b11u32)).local_into();
                        // target |= 0b100.local_into();
                ...
                Thumb::CmnRegister(cmn) => {
                    ...
                    pseudo!(ret.extend[
                        ...
                        SetVFlag(rn,shifted,false,false);
                    ]);
                    ret
                }
